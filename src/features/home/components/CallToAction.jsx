...
export default function CallToAction() {
  return (
    <section className="py-20 bg-white">
      <div className="max-w-5xl py-16 md:pl-24 md:w-full mx-2 md:mx-auto flex flex-col items-center justify-center text-center bg-linear-to-b from-[#003366] to-[#243f83] rounded-3xl p-10 text-white shadow-xl">
        <div className="flex items-center">
          ...
          <div>
            ...
            <p className="text-sm text-gray-300">Used by 12k+ companions</p>
          </div>
        </div>
        <h1 className="text-4xl md:text-[46px] md:leading-[60px] mb-3 font-semibold mt-5 bg-linear-to-r from-white to-[#CAABFF] text-transparent bg-clip-text">
          Plan your trip with confidence
        </h1>
        <p className="bg-linear-to-r from-white to-[#CAABFF] text-transparent bg-clip-text text-lg">
          Join thousands of travelers who have experienced the real Egypt
          through our trusted companion network.
        </p>
        <Button
          variant="ghost"
          size="sm"
          className="rounded-full px-4 xl:px-8 mt-4 whitespace-nowrap"
        >
          Find Your Companion
        </Button>
      </div>
